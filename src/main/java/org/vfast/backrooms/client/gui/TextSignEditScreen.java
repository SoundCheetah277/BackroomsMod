...
public class TextSignEditScreen extends AbstractTextScreen<TextSignBlockEntity> {
    public TextSignEditScreen(TextSignBlockEntity blockEntity, BlockPos pos, boolean isFrontText) {
        Identifier texture = Identifier.of(BackroomsMod.ID, "textures/item/ceiling_sign.png");
        super(blockEntity, pos, isFrontText, texture, Text.translatable("sign.edit"));
    }

    @Override
    public void renderText(GraphicsMode graphics) {
